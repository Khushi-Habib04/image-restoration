...
def main():
    ...
    opt['input_folder'] = '/home/ml/NAFNet/basicsr/datasets/val'
    opt['save_folder'] = '/home/ml/NAFNet/basicsr/datasets/val/SIDD/input_crops'
    opt['crop_size'] = 512
    opt['step'] = 384
    opt['thresh_size'] = 0
    opt['keywords'] = '_NOISY'
    ...
    opt['save_folder'] = '/home/ml/NAFNet/basicsr/datasets/val/SIDD/gt_crops'
    opt['keywords'] = '_GT'
    #extract_subimages(opt)
