...
def create_lmdb_for_SIDD():
    # folder_path = '/home/ml/NAFNet/basicsr/datasets/val/SIDD/input_crops'
    # lmdb_path = '/home/ml/NAFNet/basicsr/datasets/val/SIDD/input_crops.lmdb'

    # img_path_list, keys = prepare_keys(folder_path, 'PNG')
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # folder_path = '/home/ml/NAFNet/basicsr/datasets/val/SIDD/gt_crops'
    # lmdb_path = '/home/ml/NAFNet/basicsr/datasets/val/SIDD/gt_crops.lmdb'
